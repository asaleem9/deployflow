...
urlpatterns = [
    ...
    path("siwe/nonce/", SIWENonceEndpoint.as_view(), name="siwe-nonce"),
    path("siwe/verify/", SIWEVerifyEndpoint.as_view(), name="siwe-verify"),
    # Anonymous demo sign-in
    path("demo-login/", DemoLoginEndpoint.as_view(), name="demo-login"),
