...
class ProjectBulkAssetEndpoint(BaseAPIView):
    ...
    def post(self, request, slug, project_id, entity_id):
        ...
        # Scope to the workspace to prevent cross-workspace IDOR. Allow assets that
        # are already on the project OR not yet assigned to any project — a project
        # cover is uploaded before the project exists (project_id is null), and this
        # endpoint's job is precisely to assign that project_id.
