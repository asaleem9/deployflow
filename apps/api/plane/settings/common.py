...
# Email settings
# Filters out non-deliverable synthetic wallet addresses on every send.
EMAIL_BACKEND = "plane.utils.email_filter_backend.FilteredSMTPEmailBackend"
...
CELERY_IMPORTS = (
    ...
    # web3 on-chain integration tasks (DeployFlow)
    "plane.web3.bgtasks.explorer_sync",
    "plane.web3.bgtasks.gas_snapshot",
    "plane.web3.bgtasks.bounty_payout",
)
