...
export const CreateProjectForm = observer(function CreateProjectForm(props: TCreateProjectFormProps) {
  ...
  const onSubmit = async (formData: Partial<TProject>) => {
    ...
    return createProject(workspaceSlug.toString(), formData)
      .then(async (res) => {
        // The cover image is optional polish — the project already exists, so never
        // let a cover-image hiccup surface as a "project creation failed" error.
        try {
          if (uploadedAssetUrl) {
          ...
          console.warn("Project created; cover image could not be attached:", coverError);
        }
        setToast({
