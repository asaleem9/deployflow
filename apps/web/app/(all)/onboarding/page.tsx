  ...
  return (
    <AuthenticationWrapper pageType={EPageTypes.ONBOARDING}>
      <div className="relative flex size-full overflow-hidden rounded-lg bg-canvas transition-all duration-300 ease-in-out">
        <AuroraBackground />
        <div className="relative z-10 size-full flex-grow overflow-hidden p-2 transition-all duration-300 ease-in-out">
          <div className="glass-1 relative flex h-full w-full flex-col overflow-hidden rounded-2xl shadow-glow-brand">
